...
(function (factory) {
    ...
    var dictionary = {
        en:{days:'days',   hours:'hours',  min:'mins',  sec:'&nbsp;'},
            ...
            if(!data.vals || method === 'reset') { // new clock
                ...
                var left = Math.round(data.height / 10),
                    ...
                    thtml = (data.displayCaptions ?
                        (data.displayHours
                            ? '<span class="separator">:</span><figure style="max-width:'+ maxWidth +'px">$1<figcaption style="font-size:'+ captionSize +'px">'+ dictionary[data.lang].hours +'</figcaption></figure>'+ dot2
                            : '') +
                        '<figure style="max-width:'+ maxWidth +'px">$1<figcaption style="font-size:'+ captionSize +'px">'+ dictionary[data.lang].min +'</figcaption></figure>'+
                        '<figure class="sec" style="max-width:'+ maxWidth +'px">$1<figcaption style="font-size:'+ captionSize +'px">'+ dictionary[data.lang].sec +'</figcaption></figure>'
