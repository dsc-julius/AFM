<div class="counter-cont animated hiding" data-delay="200">
    <img src="<?php echo $theme_url; ?>/images/counter-container.png">
    <div class="auction-timer-wrapper">
        <p class="auction-timer-label">Next Auction Starts In</p>
